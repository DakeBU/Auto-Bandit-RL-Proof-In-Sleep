...
#check twoArmTerminalOptimalPullCountEvent
#check measurableSet_twoArmTerminalOptimalPullCountEvent
#check twoArmOptimalPullCountBelowEvent
#check measurableSet_twoArmOptimalPullCountBelowEvent
#check twoArmOptimalPullCountBelowEvent_eq_iUnion_terminalCount
#check twoArmTerminalOptimalPullCountEvent_sampledPseudoRegret_eq
#check twoArmOptimalPullCountBelowEvent_charge_mul_probability_le_integral
...
#print axioms twoArmOptimalPullCountBelowEvent_eq_iUnion_terminalCount
#print axioms twoArmTerminalOptimalPullCountEvent_sampledPseudoRegret_eq
#print axioms twoArmOptimalPullCountBelowEvent_charge_mul_probability_le_integral
