...
| Stochastic-gradient bandit | 352 counted audit-slice declarations comprise the historical 223-declaration Theorem-1/Appendix-E audit plus the eight follow-on layers through selected-reward aggregation. A separate ten-declaration native-law module now compiles the native stationary construction, every finite-prefix identity, and `latentArmStreamVisibleTrajectoryMeasure_eq_native`, which promotes those prefixes to equality of the complete visible/native probability measures by projective-limit uniqueness. The exact fixed-IID/Dirac two-arm Theorem 1 and its direct bounded companion compile. Selected/stopped IID, future/no-return, ballot, asymptotic assembly, and Theorem 2 remain blocked. Theorems 3--4 and general-`K` regimes remain open | `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB`, `PAPER-AUDIT-NEURIPS-2025-STOCHASTIC-GRADIENT-BANDIT`, `PAPER-AUDIT-NEURIPS-2025-SGB-PHASE-TRANSITION-PROSPECTIVE` |
...
projective-limit uniqueness.  These layers are not yet composed with the
fixed-cutoff consumer and do not make selected or stopped rewards IID.
The selected-IID law, stopped-prefix future-cylinder
