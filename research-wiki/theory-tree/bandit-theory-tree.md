...
| 14, Foundations of Information Theory | finite prefix-code/entropy definitions, prefix-to-unique-decoding and Kraft adapter, extended-real relative entropy, finite-alphabet KL with exact support endpoints, full sub-sigma-algebra and event data processing, endpoint-complete binary testing, unconditional Bretagnolle--Huber | these local leaves compile; whole chapter remains partial | Huffman/source-coding terminals, discretisation-supremum equivalence, common-density/measure-overlap route, and general Gaussian application remain; adaptive history KL belongs to Ch. 15 |
