...
| --- | --- | --- | --- |
| 13, Lower Bounds: Basic Ideas | explicit ENNReal minimax semantics and minimax-optimality; canonical finite iid Gaussian product with exact empirical-mean law; midpoint decision/error events; a genuine `exp(-n*Delta^2/8)` maximum-risk Chernoff companion; least-explored alternative averaging; quantitative two-environment algebra; the Chapter 15 Gaussian construction yields an explicit `1/54 * sqrt(k n)` endpoint | The frozen main-text contract is complete; Theorem 13.1, exact Gaussian testing and broad-class MOSS compile | exact two-sided Mills-ratio Eqs. (13.4) and (13.1) compile; the broader 1-subgaussian Algorithm 7 near-minimax claim compiles with constants 1/54, 40 and ratio 2160; integration/review/publication gates pass for b38630c; Notes/Exercises are explicitly optional |
| 14, Foundations of Information Theory | Huffman global optimum/entropy sandwich, finite uniquely-decodable/prefix equivalence, exact-real arithmetic block coding/rate converse, finite-alphabet KL, discretisation/RN and common-density equivalence, source affinity/overlap bounds, Gaussian testing and unconditional Bretagnolle--Huber | frozen required body compiled with explicit qualifications; independent review, PR #106, main run 33959196451, Pages and live desktop/mobile acceptance passed | preserve nonempty-word, exact-real and uniform-law qualifications; optional notes/exercises and adaptive history KL in Ch. 15 are outside required body |
| 15, Minimax Lower Bounds | exact Lemma 15.1/Theorem 15.2 contracts; measurable conditional-kernel KL, canonical randomized-policy histories, realized pull counts, unit-Gaussian RN/KL, least-explored alternative, source event comparison, exact tuning, and measurable-map KL data processing | Lemma 15.1, Theorem 15.2, and the worst-case/minimax consequences compile; Exercise 15.7 is partial through a compiled generic data-processing leaf and deterministic-history observation corollary | Exercise 15.7 still needs the stopped-history information bound and `F_tau` factorization; the other optional notes/exercises and distinct Chapter 16--17 consumers remain outside this milestone |
| 16, Instance-Dependent Lower Bounds | exact Definition 16.1 / Theorem 16.2 / Lemma 16.3 / Theorem 16.4 contracts; generic consistency, exact unit-Gaussian `d_inf`, eventual power/log growth, one-arm same-policy history KL, finite-mean source environment, exact Lemma 16.3, and exact Gaussian Theorem 16.4 | all four main-text targets and source mean-to-gap producer compiled | exact n-pull horizons, inverse-infimum aggregation, and finite-count Fatou retain all information branches |
| 17, High-Probability Lower Bounds | Theorem 17.1 / Corollaries 17.2--17.3, Claims 17.5--17.7, full-family Eq. (17.8), same-policy joint law, integrable fixed-table regret, CDF and deterministic extraction pass the full local root/Tests/harness gate | corrected chapter locally compiled; approved Claim 17.6 uses `<=n/2`; corrected Theorem 17.4 has `0<delta<=1/32`, `c=1/160`, `C=64` | preserve explicit source corrections; no false printed statement or new deployment is claimed |
