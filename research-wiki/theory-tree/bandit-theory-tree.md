...
| 14, Foundations of Information Theory | Huffman global optimum/entropy sandwich, finite uniquely-decodable/prefix equivalence, exact-real arithmetic block coding/rate converse, finite-alphabet KL, discretisation/RN and common-density equivalence, source affinity/overlap bounds, Gaussian testing and unconditional Bretagnolle--Huber | local terminals fully gated; whole chapter remains partial pending current-main integration and remote evidence; independent source review accepted the repair | preserve nonempty-word, exact-real and uniform-law qualifications; optional notes/exercises and adaptive history KL in Ch. 15 are outside required body |
