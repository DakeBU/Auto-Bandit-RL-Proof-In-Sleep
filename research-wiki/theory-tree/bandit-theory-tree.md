...
| 17, High-Probability Lower Bounds | exact Theorem 17.1 / Corollaries 17.2--17.3 / Theorem 17.4 / Claims 17.5--17.7 contracts; Theorem 17.1, Corollary 17.2, Claim 17.5, the correlated clipped shared-noise path, and construction-level Eq. (17.8) compile | stochastic core advanced; chapter remains partial because Corollary 17.3 and probabilistic Claims 17.6--17.7/Theorem 17.4 are blocked | prove the layer-cake/Gamma leaf for Corollary 17.3; connect the hard reward path to the policy law and prove exact clipping concentration for the adversarial branch |
