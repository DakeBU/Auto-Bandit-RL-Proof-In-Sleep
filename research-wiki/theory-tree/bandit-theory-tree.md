...
| Stochastic-gradient bandit | 316 audit-slice declarations comprise the historical 223-declaration Theorem-1/Appendix-E audit, a 23-declaration bounded Corollary-1 companion, an 18-declaration fixed-cutoff starvation consumer, a 24-declaration chronological nth-pull bridge, a seven-declaration latent reward product/readout layer, an eight-declaration deferred-decisions finite-prefix factorization, and a 13-declaration action/readout plus branch-locality-interface scaffold. The exact fixed-IID/Dirac two-arm Theorem 1 and its direct bounded companion compile. The newest layer proves the mixed-coupling next-action factorization and pathwise selected-coordinate readout, and supplies a finite/sub-Markov branch-product consumer conditional on an explicit locality premise plus count-cap measurability/recurrence. `LatentArmStreamVisiblePrefixNextActionBranchLocality` is a typed but unproved proposition; freshness, selected IID, the native visible law, future/no-return, ballot, asymptotic assembly, and Theorem 2 remain blocked. Theorems 3--4 and general-`K` regimes remain open | `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB`, `PAPER-AUDIT-NEURIPS-2025-STOCHASTIC-GRADIENT-BANDIT`, `PAPER-AUDIT-NEURIPS-2025-SGB-PHASE-TRANSITION-PROSPECTIVE` |
...
A prospectively frozen follow-on now adds 93 declarations in six deliberately
...
`LatentArmStreamVisiblePrefixNextActionBranchLocality` is only a typed,
unproved proposition: the consumer does not discharge it.  These layers are
not yet composed with the fixed-cutoff consumer.  They do not prove selected-
reward freshness, identify the mixture's visible marginal with the native
fixed-IID prefix, establish the native visible law, or make selected stopped
rewards IID.  The locality producer, freshness, selected-IID law, visible-
