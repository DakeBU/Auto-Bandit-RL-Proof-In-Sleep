...
| `TXT-LS-2020-LEMMA-16-3-FINITE-TIME` | Ch. 16, §16.2, Lemma 16.3 / Eq. (16.4), CUP print p. 180 / author-online p. 209 / physical PDF p. 218 | for a one-arm change making arm `i` uniquely optimal, lower-bound original-law expected pulls using the exact log regret-sum numerator divided by `D(P_i,P_i')` | exact target frozen; Lemma 15.1 history KL compiles, while the Chapter 16 event/information consumer remains blocked |
...
This does not by itself prove the Chapter 15 minimax terminal or later
Chapter 16--17 consumers.
