# Actual coordination pseudo-regret: coordination performance component
...
estimate n. Validation and independent review are recorded in
`runs/extended-topics-20260920/multi-agent-regret-review.json` and the separate
validation receipt; compilation alone does not establish source fidelity. No topic is complete.

## Exact production Lean

<details><summary>Actual reward, charge and expectation proofs</summary>
...
<details><summary>Four public-root canaries</summary>
