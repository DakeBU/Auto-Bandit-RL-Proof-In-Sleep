...
| `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB` | [Baudry et al., NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/a4e683f0ce6b91e7fbdae9d32642d88f-Abstract-Conference.html) | partial source audit through generated Equation-(5)/(8), conditional and unconditional two-arm recurrence, and failure-mass layers | 183 declarations compile eleven layers in the exact `26+18+18+14+4+10+3+25+19+9+37` split. The new 37-declaration layer integrates the forward/inverse conditional recurrences on a generic bounded fixed-mean trajectory, performs finite scalar iteration, and proves the source-initialized expected squared failure-mass sum bound with exact first-round contribution `1/4`. This does not compile Theorem 1: the generated-history Equation-(5)/tower best-parameter bridge, forward-potential Jensen/log consumer and explicit finite bound, fixed-IID plus Dirac-prior whole-chain specialization, and source-horizon Equation-(7)/regret constant assembly remain open. Theorems 2--4 remain open. |
