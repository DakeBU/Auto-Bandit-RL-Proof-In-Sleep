...
| `PPR-ZENG-HONORIO-2025-SUCCINCT-LOWER-BOUNDS` | [Zeng and Honorio, NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/26407588dfb08e48c459c074ab6adb7d-Abstract-Conference.html) | partial source audit aligned with the compiled Part IV information layer | the atom/support contract, source-shaped `Q`/`R`, support orthogonality, Lemmas 3.1--3.2 on succinct combinations, and a global-`R` boundedness diagnostic compile; Lemmas 3.3--3.6 and Theorem 3.8 remain open |
