...
| `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB` | [Baudry et al., NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/a4e683f0ce6b91e7fbdae9d32642d88f-Abstract-Conference.html) | partial source audit through the generated Equation-(5) bridge, two-arm Equations (9)/(11), and Equation (8) | 76 declarations compile four layers: finite softmax/update/regret algebra; recursive measurable trajectory and Equation-(5) kernel integrals; pathwise two-arm zero-sum/source-time/odds identities; and the source-exact `C_eta`, its monotonicity, plus Equation-(8) bounded-reward exponential-moment inequality. Generated conditional recurrences, expected squared failure-mass control, and all learning-rate endpoints remain open. |
