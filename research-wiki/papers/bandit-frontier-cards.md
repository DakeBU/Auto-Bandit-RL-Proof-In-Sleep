...
| `PPR-ZENG-HONORIO-2025-SUCCINCT-LOWER-BOUNDS` | [Zeng and Honorio, NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/26407588dfb08e48c459c074ab6adb7d-Abstract-Conference.html) | partial source audit aligned with the compiled Part IV information layer | 54 named declarations compile the atom/support contract, source-shaped `Q`/`R`, Definitions 3.1--3.3, Lemmas 3.1--3.4 through a finite-Bessel route, and a global-`R` boundedness diagnostic; the global Lemmas 3.5--3.6, Assumption 3.7, and Theorem 3.8 remain open |
| `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB` | [Baudry et al., NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/a4e683f0ce6b91e7fbdae9d32642d88f-Abstract-Conference.html) | partial source audit through the generated Equation-(5)/(8) bridges and two-arm initial/successor conditional recurrences | 143 declarations compile ten layers: finite softmax/update/regret algebra; recursive measurable trajectory and Equation-(5) kernel integrals; pathwise two-arm zero-sum/source-time/odds identities; standalone and generated-kernel Equation-(8) bounds; initial and fixed-history forward/inverse recurrences; measurable contract/trajectory/filtration transport; fixed-horizon path integrability plus tower-ready conditional recurrence bounds; and an eight-declaration fixed-IID source-law adapter whose `twoArmFixedIIDEnvironment_contract` gives a one-way bridge to the existing bounded fixed-mean contract. The bridge is not an equivalence and does not establish Equation-(5)'s generated-history `Integrable sourceIncrement` premise. That integrability bridge, global tower iteration, expected squared failure-mass control, Equation-(7) assembly, Theorem 1, and all Theorems 2--4 learning-rate endpoints remain open. |
