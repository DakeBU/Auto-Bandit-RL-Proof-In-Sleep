...
| `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB` | [Baudry et al., NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/a4e683f0ce6b91e7fbdae9d32642d88f-Abstract-Conference.html) | partial paper audit with one exact compiled external endpoint and bounded follow-on infrastructure | The counted ledger retains 361 audit-slice declarations through the generic finite-measure terminal-count-below regret consumer and the eight-declaration selected-reward aggregation/readout layer. A separate ten-declaration native-law module proves equality of the complete visible/native probability measures. The selected-block follow-on now also transports the latent missing-pull subset to the generated below-count event and compiles `twoArmFixedIIDMissingPullLatentPhase_charge_mul_probability_le_integral`, which charges any existing missing probability by finite-horizon expected sampled regret without proving that mass positive. The terminal `twoArmFixedIIDDirac_theoremOne` remains the source Theorem 1 for fixed two-arm IID laws, a Dirac environment prior, source `T = tailHorizon + 1`, and the exact constants and assumptions. Theorem 2 remains blocked at the generated all-present phase's recurrence-to-trigger implication, the stopped-prefix future/no-return law, conditional no-return, the ballot phase, and asymptotic assembly; the separate Appendix-E gate does not prove Theorem 4. Theorems 2--4 and the full paper remain open. |
