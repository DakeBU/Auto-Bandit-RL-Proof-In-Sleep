...
| `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB` | [Baudry et al., NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/a4e683f0ce6b91e7fbdae9d32642d88f-Abstract-Conference.html) | partial paper audit with one exact compiled external endpoint and a bounded source-contract diagnosis | 223 declarations comprise the frozen 215-declaration Theorem-1 stack (`26+18+18+14+4+10+3+25+19+9+37+32`) plus 8 Appendix-E/Theorem-4 contract-audit leaves. The terminal `twoArmFixedIIDDirac_theoremOne` is the source Theorem 1 for fixed two-arm IID laws, a Dirac environment prior, source `T = tailHorizon + 1`, and the exact constants and assumptions. The separate gate proves only the positive drift margin, audited finite survival-event composition under explicit premises, and finite geometric phase envelope; it exposes an unresolved Step-4 direction/conditioning mismatch but does not prove Theorem 4. Theorems 2--4 and the full paper remain open. |
