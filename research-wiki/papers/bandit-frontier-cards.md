...
| `PPR-BAUDRY-JOHNSON-VARY-PIKEBURKE-REBESCHINI-2025-SGB` | [Baudry et al., NeurIPS 2025](https://proceedings.neurips.cc/paper_files/paper/2025/hash/a4e683f0ce6b91e7fbdae9d32642d88f-Abstract-Conference.html) | partial source audit through the generated Equation-(5)/(8) bridges and two-arm initial/successor conditional recurrences | 135 declarations compile nine layers: finite softmax/update/regret algebra; recursive measurable trajectory and Equation-(5) kernel integrals; pathwise two-arm zero-sum/source-time/odds identities; standalone and generated-kernel Equation-(8) bounds; initial and fixed-history forward/inverse recurrences; measurable contract/trajectory/filtration transport; and fixed-horizon path integrability plus tower-ready conditional recurrence bounds. The bounded fixed-mean contract is not an equivalent fixed-iid-law encoding. Global tower iteration, expected squared failure-mass control, Equation-(7) assembly, Theorem 1, and all Theorems 2--4 learning-rate endpoints remain open. |
