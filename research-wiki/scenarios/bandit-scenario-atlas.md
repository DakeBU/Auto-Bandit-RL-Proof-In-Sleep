...
This atlas is ABRL's current scenario taxonomy as of July 3, 2026.  It is a
...
| `SCN-BOBW-ADAPTIVE` best-of-both-worlds/adaptive bandits | Tsallis-INF, LC-Tsallis-INF, adaptive FTRL | `PPR-ZIMMERT-SELDIN-2018-TSALLIS-INF`, `PPR-MASOUDIAN-SELDIN-2021-TSALLIS-INF`, `PPR-KATO-ITO-2024-LC-TSALLIS-INF`, `PPR-KUROKI-RUMI-TSUCHIYA-VITALE-CESABIANCHI-2023-BOBW-LCB`, `PPR-ADAPTIVE-LR-FTRL-2024` | Tsallis regularization, self-bounding conversion, FTRL stability/penalty, adaptive learning rates | `MLIB-REAL-RPOW-TSALLIS`, `MLIB-CONVEX-LINALG`, `MLIB-FINSET-SUMS`, `MLIB-EXP-LOG-INEQUALITIES` |
...
| `SCN-DELAYED-BOBW` delayed best-of-both-worlds bandits | delayed SAPO with a post-detection adversarial algorithm | `PPR-SCHLISSELBERG-LANCEWICKI-AUER-MANSOUR-2025-DELAYED-BOBW`, `PPR-ZIMMERT-SELDIN-2018-TSALLIS-INF` | source-time feedback queues, unknown-at-action-time delays, one-algorithm/tuning coupling, stochastic/adversarial expected regret | `MLIB-FINSET-SUMS`, `MLIB-MARTINGALE-STOCHASTIC`, `MLIB-CONDITIONAL-EXPECTATION` |
...
| `SCN-LLM-REC-SYS` LLM/recommender/neural bandits | neural contextual bandits, bandit prompt optimization, LLM-assisted priors | `PPR-LI-CHU-LANGFORD-SCHAPIRE-2010-LINUCB`, `PPR-FEDERATED-NEURAL-BANDITS-2022`, `PPR-EMNLP-2024-LLM-PRIOR-BANDITS`, `PPR-BOUNEFFOUF-FERAUD-2025-MAB-LLM` | offline-to-online priors, context embeddings, model-selection regret, adaptive response generation | `MLIB-MEASURE-INTEGRAL`, `MLIB-PROBABILITY-KERNEL`, `MLIB-CONVEX-LINALG` |
