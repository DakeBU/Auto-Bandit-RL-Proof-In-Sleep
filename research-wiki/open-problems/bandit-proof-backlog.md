...
| `BRL-OP-ETC-SUBGAUSS-001` | stochastic bandit | ETC wrong-commit probability | theorem-card | sub-Gaussian sum lemma |
| `BRL-OP-TS-BAYES-001` | Bayesian bandit | Thompson sampling Bayesian regret | theorem-card | posterior action identity ledger |
