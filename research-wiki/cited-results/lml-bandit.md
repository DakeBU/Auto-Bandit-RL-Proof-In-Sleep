...
| `LML-BANDIT-REGRET-PULLCOUNT` | LeanMachineLearning/LML `Bandits.regret_eq_sum_pullCount_mul_gap` | regret equals sum over arms of pull count times gap | theorem-card | UCB, ETC tasks | not local proof yet |
