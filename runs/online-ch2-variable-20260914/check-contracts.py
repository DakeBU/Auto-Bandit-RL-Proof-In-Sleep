"""Verify the frozen variable-OGD headers and definition context; not a Lean build."""
import hashlib,json,subprocess,sys
from pathlib import Path
root=Path(__file__).resolve().parents[2]
contracts=root/'docs/contracts/online-ogd-variable-v1'
module=root/'BanditRLProof/OnlineGradientDescentVariable.lean'
