...
c=root/'docs/contracts/online-guessing-lower-v2';m=root/'BanditRLProof/OnlineGuessingLower.lean'
...
assert s.startswith(ctx['prefix']) and hashlib.sha256(ctx['prefix'].encode()).hexdigest()==ctx['sha256']
