...
- Contributors own their mathematical claims and receive persistent credit;
  maintainers do not imply endorsement by cited authors or projects.
- Reviewers may request changes to assumptions, statement equivalence,
  namespace, API shape, proof structure, documentation, tests, or attribution.
- Maintainers decide whether and when a proposal is integrated into the core
  library. Integration requires a passed Lean project gate and a regenerated
  site; a public packet alone is never marked integrated.
...
Changes to this governance document are made through public pull requests.
