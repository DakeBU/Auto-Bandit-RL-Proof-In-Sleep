...
GITHUB_REPO = "review:repository"
PUBLIC_SITE_REPO = GITHUB_REPO
PUBLIC_SITE_URL = "review:site"
LIBRARY_NAME = "BanditRLlib"
RESEARCH_PROJECT = "Anonymous"
PAPER_TITLE = (
  ...
  <div class="site-content">
    ...
    <footer class="site-footer">
      <div class="footer-inner">
        <p><strong>BanditRLlib</strong> is the public Lean library and community interface produced by <strong>Anonymous (ABRL)</strong>. Generated from current sources at {html.escape(generated_at)}; exact Lean statements and verification status take precedence.</p>
...
<section id="contribute-graph">
  ...
  <p class="reference-note">The independent interaction design is informed by Samplinglib's public <a href="https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/lean-foundations.html">Underlying Lean Graph of Libraries</a>. No Samplinglib source, stylesheet, template, or graph data is copied.</p>
</section>
"""
    toc: list[tuple[str, str]] = []
    write_page(
...
<section id="lean-ridgelet">
  ...
  <div class="callout warning">This attribution records inspiration only. It does not imply that Sho Sonoda participated in, reviewed, endorsed, or maintains Anonymous.</div>
</section>
...
<section id="samplinglib">
  ...
  <p>The progressive graph explorer is informed by the public <a href="https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/lean-foundations.html">Underlying Lean Graph of Libraries</a> in <a href="review:repository">Auto-Sampling-Theory-In-Sleep / Samplinglib</a>. BanditRLwiki's setting → case → frontier information architecture is also informed by its public <a href="https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/example-cases/samplewiki.html">SampleWiki</a> and <a href="https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/example-cases/samplewiki/frontier.html">Sampling Frontier</a>.</p>
...
[Underlying Lean Graph of Libraries](https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/lean-foundations.html).
BanditRLwiki's assumption-setting and frontier organization is informed by its
[SampleWiki](https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/example-cases/samplewiki.html)
and [Frontier](https://Anonymous.github.io/Auto-Sampling-Theory-In-Sleep/example-cases/samplewiki/frontier.html).
...
if __name__ == "__main__":
    raise SystemExit("Use build_site.py: this snapshot always builds anonymously")
