...
\section{Chapter 15 Gaussian KL and tuning slice with exact minimax blocker}

\paragraph{Status.}
This note is a synchronized natural-language export for task \texttt{TEXTBOOK-PART-IV-CHAPTER-15-MINIMAX-LOWER-BOUNDS-SPINE}.
