...
The final two declarations prove that an actual `WithTop.top` requested pull
forces every finite-horizon optimal-arm count below the requested index, and
strengthen this to the requested finite block size.
