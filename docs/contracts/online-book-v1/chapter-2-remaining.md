...
Subsequent Jensen frontier update: exact arbitrary-convex barycenter accepted-local in PR126; exact global affine minorant accepted-local in runs/online-minorant-20260914. Negative-part/source endpoint and finite/infinite-probability canaries compile only in retained scratch. Public Jensen integration and full acceptance remain required; the earlier all-four-unproved entry is historical. No Chapter2 completion.

Theorem2.9 full source update: accepted-local in runs/online-jensen-source-20260914 after exact finite-negative-part and source endpoint proofs, finite/infinite-probability/nonclosed public canaries and all combined gates. online-jensen-v3 imports actual shared dependencies with unchanged parent headers. Example2.10 is frozen and scratch-compiled but not public accepted. Later Chapter2 obligations remain required.

Example2.10 accepted-local in runs/online-ftl-failure-20260914: actual recursive causal FTL, historical minimization and exact T-1-x0/2 regret bound, all scoped gates passed. Example2.14 has six frozen scratch-compiled targets and canaries, public acceptance pending. Example2.15 and later required subgradient results remain incomplete.

Example2.14 accepted-local in runs/online-guessing-ogd-20260914: exact interval projection, squared-loss regularity/gradient, tuned 2sqrtT upper guarantee and a separately derived same-algorithm square-horizon lower witness supporting the comparative remark. Nine public targets passed combined gates. Huber seam and scalar representation are retained scratch foundations only; Example2.15, subgradient results and Chapter2 remain incomplete.
