...
Public integration v2 changes only the module/fence file path. All seven headers and the exact prefix containing definitions are unchanged. Original v1 native fences remain historical. No target assumption or algorithm identity changes. Public source/axiom/root/Tests/full-harness/site/graph acceptance remains required.
