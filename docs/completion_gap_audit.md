...
| Linear/OFUL/LinUCB | local Gram PSD wrapper and Mathlib Schur-complement rank-one determinant-update wrapper compiled; paper/weapon cards for the rest | regularized Gram invertibility, log-det telescope, determinant growth inequalities, confidence ellipsoid, self-normalized tail |
