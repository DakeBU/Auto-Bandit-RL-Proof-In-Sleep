...
LOCAL_LEAF_CARDS = [
    ...
    },
    {
        ...
        "role": "Compiled definitional generated-action raw-range/measurable-mean-range source contract for the COND-EXPECT-REWARD route: it removes the explicit action trace and timewise action-measurability inputs from the practical raw-range source by using generatedActionFromRewardHistory plus GeneratedActionRandomPairDefinitionalMapSource, then converts to the existing raw-range source to expose integrability, full finite-pair-trace partialTraj law, and succ-indexed conditional mean-zero. This still assumes the definitional random next-pair law source, mean measurability, deterministic raw reward and mean range bounds, ambient trajectory-to-condExpKernel identification, and final adaptive theorem.",
        "mathlib_routes": [
            "MLIB-MEASURE-INTEGRAL",
            "MLIB-CONDITIONAL-EXPECTATION",
            "LOCAL-LEAF-COND-EXPECT-REWARD-GENERATED-DEFINITIONAL-MAP-SOURCE-CONTRACT",
