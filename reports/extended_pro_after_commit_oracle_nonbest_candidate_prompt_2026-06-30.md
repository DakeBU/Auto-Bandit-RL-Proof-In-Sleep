# Extended Pro Review Prompt: After Oracle If-Zeroed Nonbest Probability Wrapper
...
lake build Tests
python3 tools/bandit.py list-lean-decls ETC.prob_commitOracle_ne_bestArm_le_sum_nonbest_pairwise_tail --statement
