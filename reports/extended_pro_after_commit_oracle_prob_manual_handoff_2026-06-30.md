# Manual Extended Pro Handoff: After Oracle Pairwise-Tail Probability Wrapper
...
4. Record the completed response:
   ...
   ```powershell
   python3 tools\bandit.py extended-pro-record-response --raw PATH --output reports\extended_pro_after_commit_oracle_prob_response_2026-06-30.md --url URL --chosen-leaf CHOSEN --classification project-local
   ```
