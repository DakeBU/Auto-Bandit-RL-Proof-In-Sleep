# Manual Extended Pro Handoff: After ETC BestArm Suffix No-Regret
...
4. Record the completed response:
   ...
   ```powershell
   python3 tools\bandit.py extended-pro-record-response --raw PATH --output reports\extended_pro_after_bestarm_suffix_no_regret_response_2026-06-30.md --url URL --chosen-leaf CHOSEN --classification project-local
   ```
