# Manual Extended Pro Handoff: After Finite-Bandit Gap BestArm Ledger
...
4. Record the completed response:
   ...
   ```powershell
   python3 tools\bandit.py extended-pro-record-response --raw PATH --output reports\extended_pro_after_gap_bestarm_response_2026-06-30.md --url URL --chosen-leaf CHOSEN --classification project-local
   ```
