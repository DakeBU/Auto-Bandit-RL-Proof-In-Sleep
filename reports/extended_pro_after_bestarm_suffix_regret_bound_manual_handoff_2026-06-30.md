# Manual Extended Pro Handoff: After ETC BestArm Suffix Regret Bound
...
4. Record the completed response:
   ...
   ```powershell
   python3 tools\bandit.py extended-pro-record-response --raw PATH --output reports\extended_pro_after_bestarm_suffix_regret_bound_response_2026-06-30.md --url URL --chosen-leaf CHOSEN --classification project-local
   ```
