# Required Jensen obligations

- Seven signed expectation foundations: accepted-local; expectation-acceptance-decision.md.
- Convex affine minorant in finite dimension: frozen, unproved.
- Barycenter membership in arbitrary finite-dimensional convex set: frozen, unproved.
...
Supporting-functional a.e. equality and finite-dimensional separator: scratch compiled candidates only; public integration/canary/graph with barycenter pending.
