...
- **2026-08 — Part IV Chapters 13--14 lower-bound spine.** The separate source-faithful textbook layer now compiles Chapter 13 minimax semantics, least-explored-arm and error-bearing two-environment algebra, followed by Chapter 14 extended-real relative entropy, event-level binary data processing, endpoint-complete binary testing, and the unconditional Bretagnolle--Huber theorem. Theorem 13.1 and the same-policy adaptive-history KL decomposition remain explicitly assigned to Chapter 15; Chapter 14 does not claim entropy/source coding or full sub-sigma-algebra data processing.
